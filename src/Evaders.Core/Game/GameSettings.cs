namespace Evaders.Core.Game
{
    ...
    public class GameSettings
    {
        ...
        [JsonProperty]
        public readonly int OutOfArenaDamagePerTurn;
        ...
        [JsonProperty]
        public readonly int HealorbHitboxSize;

        [JsonProperty]
        public readonly double HealorbRespawnSec;

        [JsonProperty]
        public readonly int HealorbHealAmount;

        [JsonProperty]
        public readonly int CloneorbHitboxSize;

        [JsonProperty]
        public readonly double CloneorbRespawnSec;
