...
* @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
*/
n.TilemapParser={INSERT_NULL:!1,parse:function(t,i,r,u,f,e){if(r===undefined&&(r=32),u===undefined&&(u=32),f===undefined&&(f=10),e===undefined&&(e=10),i===undefined)return this.getEmptyData();if(i===null)return this.getEmptyData(r,u,f,e);var o=t.cache.getTilemapData(i);if(o){if(o.format===n.Tilemap.CSV)return this.parseCSV(i,o.data,r,u);if(!o.format||o.format===n.Tilemap.TILED_JSON)return this.parseTiledJSON(o.data)}else console.warn("Phaser.TilemapParser.parse - No map data found for key "+i)},parseCSV:function(t,i,r,u){var f=this.getEmptyData(),e,h,o;i=i.trim();var c=[],l=i.split("\n"),a=l.length,s=0;for(e=0;e<l.length;e++){for(c[e]=[],h=l[e].split(","),o=0;o<h.length;o++)c[e][o]=new n.Tile(f.layers[0],parseInt(h[o],10),o,e,r,u);s===0&&(s=h.length)}return f.format=n.Tilemap.CSV,f.name=t,f.width=s,f.height=a,f.tileWidth=r,f.tileHeight=u,f.widthInPixels=s*r,f.heightInPixels=a*u,f.layers[0].width=s,f.layers[0].height=a,f.layers[0].widthInPixels=f.widthInPixels,f.layers[0].heightInPixels=f.heightInPixels,f.layers[0].data=c,f},getEmptyData:function(n,t,i,r){return{width:i!==undefined&&i!==null?i:0,height:r!==undefined&&r!==null?r:0,tileWidth:n!==undefined&&n!==null?n:0,tileHeight:t!==undefined&&t!==null?t:0,orientation:"orthogonal",version:"1",properties:{},widthInPixels:0,heightInPixels:0,layers:[{name:"layer",x:0,y:0,width:0,height:0,widthInPixels:0,heightInPixels:0,alpha:1,visible:!0,properties:{},indexes:[],callbacks:[],bodies:[],data:[]}],images:[],objects:{},collision:{},tilesets:[],tiles:[]}},parseTiledJSON:function(t){function vt(n,t){var r={},u,i;for(u in t)i=t[u],typeof n[i]!="undefined"&&(r[i]=n[i]);return r}var s,st,e,ht,p,ft,lt,at,rt,l,d,et,r,u,nt,a,o,k,v,h,ni,i,f,c,ot;if(t.orientation!=="orthogonal")return console.warn("TilemapParser.parseTiledJSON - Only orthogonal map types are supported in this version of Phaser"),null;for(s={width:t.width,height:t.height,tileWidth:t.tilewidth,tileHeight:t.tileheight,orientation:t.orientation,format:n.Tilemap.TILED_JSON,version:t.version,properties:t.properties,widthInPixels:t.width*t.tilewidth,heightInPixels:t.height*t.tileheight},st=[],f=0;f<t.layers.length;f++)if(t.layers[f].type==="tilelayer"){if(e=t.layers[f],!e.compression&&e.encoding&&e.encoding==="base64"){var it=window.atob(e.data),nt=it.length,pt=new Array(nt);for(c=0;c<nt;c+=4)pt[c/4]=(it.charCodeAt(c)|it.charCodeAt(c+1)<<8|it.charCodeAt(c+2)<<16|it.charCodeAt(c+3)<<24)>>>0;e.data=pt;delete e.encoding}else if(e.compression){console.warn("TilemapParser.parseTiledJSON - Layer compression is unsupported, skipping layer '"+e.name+"'");continue}v={name:e.name,x:e.x,y:e.y,width:e.width,height:e.height,widthInPixels:e.width*t.tilewidth,heightInPixels:e.height*t.tileheight,alpha:e.opacity,visible:e.visible,properties:{},indexes:[],callbacks:[],bodies:[]};e.properties&&(v.properties=e.properties);var w=0,b=[],ut=[],y,tt,g,l;for(k=0,nt=e.data.length;k<nt;k++){if(y=0,tt=!1,l=e.data[k],g=0,l>536870912){l>2147483648&&(l-=2147483648,g+=4);l>1073741824&&(l-=1073741824,g+=2);l>536870912&&(l-=536870912,g+=1);switch(g){case 5:y=Math.PI/2;break;case 6:y=Math.PI;break;case 3:y=3*Math.PI/2;break;case 4:y=0;tt=!0;break;case 7:y=Math.PI/2;tt=!0;break;case 2:y=Math.PI;tt=!0;break;case 1:y=3*Math.PI/2;tt=!0}}l>0?(h=new n.Tile(v,l,w,ut.length,t.tilewidth,t.tileheight),h.rotation=y,h.flipped=tt,g!==0&&(h.flippedVal=g),b.push(h)):n.TilemapParser.INSERT_NULL?b.push(null):b.push(new n.Tile(v,-1,w,ut.length,t.tilewidth,t.tileheight));w++;w===e.width&&(ut.push(b),w=0,b=[])}v.data=ut;st.push(v)}for(s.layers=st,ht=[],f=0;f<t.layers.length;f++)t.layers[f].type==="imagelayer"&&(p=t.layers[f],rt={name:p.name,image:p.image,x:p.x,y:p.y,alpha:p.opacity,visible:p.visible,properties:{}},p.properties&&(rt.properties=p.properties),ht.push(rt));s.images=ht;var wt=[],bt=[],ct=null;for(f=0;f<t.tilesets.length;f++){if(i=t.tilesets[f],i.image)ft=new n.Tileset(i.name,i.firstgid,i.tilewidth,i.tileheight,i.margin,i.spacing,i.properties),i.tileproperties&&(ft.tileProperties=i.tileproperties),ft.updateTileData(i.imagewidth,i.imageheight),wt.push(ft);else{lt=new n.ImageCollection(i.name,i.firstgid,i.tilewidth,i.tileheight,i.margin,i.spacing,i.properties);for(at in i.tiles)rt=i.tiles[at].image,l=i.firstgid+parseInt(at,10),lt.addImage(l,rt);bt.push(lt)}ct&&(ct.lastgid=i.firstgid-1);ct=i}for(s.tilesets=wt,s.imagecollections=bt,d={},et={},f=0;f<t.layers.length;f++)if(t.layers[f].type==="objectgroup")for(r=t.layers[f],d[r.name]=[],et[r.name]=[],u=0,nt=r.objects.length;u<nt;u++)if(r.objects[u].gid)o={gid:r.objects[u].gid,name:r.objects[u].name,type:r.objects[u].hasOwnProperty("type")?r.objects[u].type:"",x:r.objects[u].x,y:r.objects[u].y,visible:r.objects[u].visible,properties:r.objects[u].properties},r.objects[u].rotation&&(o.rotation=r.objects[u].rotation),d[r.name].push(o);else if(r.objects[u].polyline){for(o={name:r.objects[u].name,type:r.objects[u].type,x:r.objects[u].x,y:r.objects[u].y,width:r.objects[u].width,height:r.objects[u].height,visible:r.objects[u].visible,properties:r.objects[u].properties},r.objects[u].rotation&&(o.rotation=r.objects[u].rotation),o.polyline=[],a=0;a<r.objects[u].polyline.length;a++)o.polyline.push([r.objects[u].polyline[a].x,r.objects[u].polyline[a].y]);et[r.name].push(o);d[r.name].push(o)}else if(r.objects[u].polygon){for(o=vt(r.objects[u],["name","type","x","y","visible","rotation","properties"]),o.polygon=[],a=0;a<r.objects[u].polygon.length;a++)o.polygon.push([r.objects[u].polygon[a].x,r.objects[u].polygon[a].y]);d[r.name].push(o)}else r.objects[u].ellipse?(o=vt(r.objects[u],["name","type","ellipse","x","y","width","height","visible","rotation","properties"]),d[r.name].push(o)):(o=vt(r.objects[u],["name","type","x","y","width","height","visible","rotation","properties"]),o.rectangle=!0,d[r.name].push(o));for(s.objects=d,s.collision=et,s.tiles=[],f=0;f<s.tilesets.length;f++){var i=s.tilesets[f],w=i.tileMargin,kt=i.tileMargin,dt=0,yt=0,gt=0;for(k=i.firstgid;k<i.firstgid+i.total;k++){if(s.tiles[k]=[w,kt,f],w+=i.tileWidth+i.tileSpacing,dt++,dt===i.total)break;if(yt++,yt===i.columns&&(w=i.tileMargin,kt+=i.tileHeight+i.tileSpacing,yt=0,gt++,gt===i.rows))break}}for(f=0;f<s.layers.length;f++)for(v=s.layers[f],i=null,c=0;c<v.data.length;c++)for(b=v.data[c],ot=0;ot<b.length;ot++)(h=b[ot],h===null||h.index<0)||(ni=s.tiles[h.index][2],i=s.tilesets[ni],i.tileProperties&&i.tileProperties[h.index-i.firstgid]&&(h.properties=n.Utils.mixin(i.tileProperties[h.index-i.firstgid],h.properties)));return s}};
/**
* @author       Richard Davey <rich@photonstorm.com>
* @copyright    2016 Photon Storm Ltd.
* @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
